	...
	<div class="container">
		...
		<div class="wrapper clearfix">
			<div class="sidebar f_r">
				...
				<div class="hot m_10">
					<div class="title5">
						<h2><i class="fa fa-rocket fa-2x"></i>热卖商品</h2>
					</div>
			...
			<div class="main f_l">
				...
				<div class="box m_10">
					<div class="title title3">
						...
						<p style="color: #666666;">new products</p>
					</div>
					<div class="cont clearfix">
						<ul class="prolist">
                ...
                <!--商品分类展示 start-->
                <!--商品分类统计-->
                <div class="category box m_10">
                    <div class="title2">
                        <h2 style="color: orange; font-size: 18px;">
                            商品分类
                        </h2>
						<p style="color: #666666;">Categories</p>
                    </div>
                </div>
				...
				<div class="comment box m_10">
					<div class="title title3">
						...
						<p style="color: #666666;">The latest comments</p>
					</div>
					<div class="cont clearfix">
