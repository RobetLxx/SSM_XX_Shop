			...
			<div class="main f_r">
				...
				<div class="box clearfix">
					...
					<dl class="userinfo_box">
						<dt>
							<a class="ico">
								<img id="user_ico_img"
									 src="${sessionScope.user.user_img}" width="100" height="100" alt="加载失败" /></a>
				...
				<div class="box m_10">
					<table class="list_table" width="100%" cellpadding="0"
						...
						<col width="140px" />
						<tr>
							<th><i class="fa fa-hashtag fa-fw"></i>订单编号</th>
							<th><i class="fa- fa-clock-o fa-fw"></i>下单日期</th>
							<th><i class="fa fa-user-circle fa-fw"></i>收货人</th>
							<th><i class="fa fa-spinner fa-fw"></i>支付方式</th>
							<th><i class="fa fa-money fa-fw"></i>总金额</th>
							<th><i class="fa fa-refresh fa-fw"></i>订单状态</th>
						</tr>
