			...
			<div class="main f_r">
				...
				<div class="box m_10">
					<table class="list_table" width="100%" cellpadding="0"
						...
						<col width="140px" />
						<tr>
							<th><i class="fa fa-th-list fa-lg"></i>订单编号</th>
							<th><i class="fa fa-clock-o fa-lg"></i>下单日期</th>
							<th><i class="fa fa-user-circle-o fa-lg" ></i>收货人</th>
							<th><i class="fa fa-rmb fa-lg"></i>支付方式</th>
							<th><i class="fa fa-money fa-lg"></i>总金额</th>
							<th><i class="fa fa-refresh fa-lg"></i>订单状态</th>
						</tr>
