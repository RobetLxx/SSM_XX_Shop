		...
		<div class="wrapper clearfix">
			...
			<div class="main f_r">
				...
				<div class="orange_box" id='address_form'>
					<form action='./usercenter/address/updateinfo' method='post' name='form'>
						<table class="form_table" width="100%" cellpadding="0"
							...
							<tr>
								<th><span class="red">*</span> 地址id：</th>
                            	<td><input type="hidden" name="id" value="${address.id}"></td>
							</tr>
							<tr>
								<th><span class="red">*</span> 收货人姓名：</th>
								<td><input name='accept' class="normal" type="text" value="${address.accept}" /><label>收货人真实姓名，方便快递公司联系</label></td>
							</tr>
							<tr>
								<th><span class="red">*</span> 所在地区：</th>
								<td><select name="province" id="province" value="${address.province}"></select>
									<select name="city" id="city" value="${address.city}"></select>
									<select name="area" id="area" value="${address.area}"></select></td>
							</tr>
							<tr>
								<th><span class="red">*</span> 街道地区：</th>
								<td><input name='address' class="normal"
									type="text" value="${address.address}"/><label>真实详细收货地址，方便快递公司联系</label></td>
							</tr>
							<tr>
								<th>邮政编码：</th>
								<td><input name='zip' class="normal" type="text" value="${address.zip}"/><label>邮政编码,如250000</label></td>
							</tr>
							<tr>
								<th>手机号码：</th>
								<td><input name='phoneNum' class="normal"
									type="text" value="${address.phoneNum}" /><label>手机号码，如：13588888888</label></td>
							</tr>
							<tr>
								<th>设为默认：</th>
