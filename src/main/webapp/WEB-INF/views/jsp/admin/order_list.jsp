				...
				<div class="searchbar">
					<form action="./order/listByPage" method="post" id="form1">
						...
						<%--<select name="queryPayStatus" class="auto" id="payStatus">--%>
							...
							<option value="-1" disabled selected>选择支付状态</option>
				...
				<div class="field">
					<table class="list_table">
						...
						<thead>
							<tr>
								<th class="t_c">选择</th>
								<th><i class="fa fa-hashtag fa-fw"></i>订单号</th>
								<th><i class="fa fa-user-circle fa-fw"></i>收货人</th>
								<th><i class="fa fa-usd fa-fw" ></i>支付状态</th>
								<th><i class="fa fa-truck fa-fw"></i>发货状态</th>
								<th><i class="fa fa-truck fa-fw"></i>配送方式</th>
								<th><i class="fa fa-spinner fa-fw"></i>支付方式</th>
								<th><i class="fa fa-user fa-fw"></i>用户名</th>
								<th><i class="fa- fa-clock-o fa-fw"></i>下单时间</th>
								<th><i class="fa fa-gear fa-fw"></i>操作</th>
							</tr>
						</thead>
					</table>
				</div>
						...
						<tbody>
							<c:forEach items="${pageBean.data}" var="order">
								<tr>
									...
									<td><a href="./admin/toOrderView?orderid=${order.id}">
