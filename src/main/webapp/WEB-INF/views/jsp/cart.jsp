...
<script type="text/javascript">
	...
	// 	location.href="./cart/numadd?id="+id+"&num="+num;
    // }
    // function renum(id,num) {
	// 	if ((num-1)!=0){
    //         location.href="./cart/numre?id="+id+"&num="+num;
	// 	}
    // }
	...
	<div class="brand_list container_2">
		...
		<div class="wrapper clearfix">
			<div class="position mt_10">
				<span>您当前的位置：</span> <a href="">首页</a> » <i class="fa fa-shopping-bag fa-lg"></i>购物车
			</div>
			<div class="myshopping m_10">
				<ul class="order_step">
					<li class="current"><span class="first"><i class="fa fa-shopping-bag fa-2x"></i>1、查看购物车</span></li>
					<li><span><i class="fa fa-columns fa-2x"></i>2、填写核对订单信息</span></li>
					<li class="last"><span><i class="fa fa-check fa-2x"></i>3、成功提交订单</span></li>
				</ul>
			</div>
			<form action="./order/addCastOrder" id="form1">
				<table width="100%" class="cart_table m_10">
					...
					<thead>
						<tr>
							<th><i class="fa fa-photo fa-lg"></i>图片</th>
							<th><i class="fa fa-photo fa-lg"></i>商品名称</th>
							<th><i class="fa fa-rmb fa-lg"></i>单价</th>
							<th><i class="fa fa-th-large fa-lg"></i>数量</th>
							<th><i class="fa fa-money fa-lg"></i>小计</th>
							<th class="last"><i class="fa fa-thumbs-up fa-lg"></i>操作</th>
						</tr>
					</thead>
					...
					<tbody id="goodsList">
						...
						<c:forEach items="${cartList}" var="cart" varStatus="s">
							...
							<tr>
								...
								<td>
									<dd>
										<div class="resize">
											<a class="add" id="add" href="/cart/numadd?id=${cart.id}"></a>
												${cart.num}
											<a class="reduce" id="reduce" href="/cart/numre?id=${cart.id}"></a>
										</div>
									</dd>
								</td>
								...
								<td><!-- 修改操作 -->
									<%--<a href="./cart/update?cartId="${cart.id}" target="_blank">--%>
						...
						<tr class="stats">
							<td colspan="8">金额总计（不含运费）：<b class="orange" id='sum_price'>${sum}</b></td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
