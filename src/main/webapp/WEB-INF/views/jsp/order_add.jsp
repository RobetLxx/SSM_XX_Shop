...
<script type="text/javascript">
	...
	<script type="text/javascript">
		function x(){
                    var money=$("input[name='deliveryType']:checked").val();
                    document.getElementById("delivery_fee_show").innerHTML=money;
                    var totalmoney=document.getElementsByName("totalMoney")[0].value;
                    var toMoney=parseInt(money)+parseInt(totalmoney);
                    document.getElementById("final_sum").innerHTML=toMoney;
		}
        window.onload=x;
			...
			<div class="myshopping m_10">
				<ul class="order_step">
					<li class="current_prev"><span class="first"><a
							href='javascript:window.history.go(-1);'><i class="fa fa-shopping-bag fa-2x"></i>1、查看购物车</a></span></li>
					<li class="current"><span><i class="fa fa-columns fa-2x"></i>2、填写核对订单信息</span></li>
			...
			<form action='./order/submit' method='post' name='order_form'
								...
								<tbody id="deliveryFormTrBox">
									<tr>
										<th><label><input type="radio"
												name="deliveryType" class="dx" paytype="0" alt="20.00" checked
												value="20">快递</label></th>
										<td>直接由第三方物流公司配送 运费：￥20.00 &nbsp;&nbsp;</td>
									</tr>
									<tr>
										<th><label><input type="radio"
												name="deliveryType" class="dx" paytype="0" alt="10.00"
												value="10">EMS</label></th>
										<td>运费：￥10.00 &nbsp;&nbsp;</td>
									</tr>
								</tbody>
								<tfoot>
				...
				<div class="cart_box" id='amountBox'>
					<div class="cont_2">
						...
						<div class="pink_box">
							<p class="f14 t_l">
								商品总金额：<b>${totalMoney}</b> + 运费总计：<b id='delivery_fee_show'></b>
							</p>
						</div>
						<hr class="dashed" />
