...
public class GoodsServiceImpl implements GoodsService {
    ...
    */
    ...
    public void addGoods(Goods goods) {
        goods.setId(ShopUtil.getId());
        goodsDao.addGoods(goods);
        categoryDao.updateGoodsNum(goods.getCategoryId(),categoryDao.getCategoryById(goods.getCategoryId()).getGoodsNum()+1);
    }
