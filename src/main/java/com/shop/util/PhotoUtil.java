...
//        String saveFilePath = "images/uploadFile";
        ...
        //文件的扩张名
//        String extensionName = ShopUtil.getId() + filename.substring(filename.lastIndexOf(".") + 1);
        String extensionName = ShopUtil.getId() + filename.substring(filename.lastIndexOf("."));
        try {
